...
import { GitHubAuthModule } from '../common/github/github-auth.module';
import { ParserConfigModule } from '../common/parser/parser-config.module';
import { FetcherWorker } from './fetcher.worker';
import { ParserWorker } from './parser.worker';
import { EmbeddingWorker } from './embedding.worker';

@Module({
  imports: [DatabaseModule, QueueModule, S3Module, TensorModule, GitHubAuthModule, ParserConfigModule],
